...
@Component({
  selector: 'app-affectation-formateur',

  templateUrl: './affectation-formateur.component.html',
  styleUrl: './affectation-formateur.component.css',
})
export class AffectationFormateurComponent {
  user: any = {};
  userId: string = '';
  userForm!: FormGroup;
  groupesTab: any = [];
